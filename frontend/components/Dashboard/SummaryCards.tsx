  ...
  const cards = [
    {
      ...
      subColor: stats.totalGain >= 0 ? 'text-emerald-600' : 'text-[#BA1A1A]',
    },
    {
      ...
      subColor: stats.dayChange >= 0 ? 'text-emerald-600' : 'text-[#BA1A1A]',
    },
    {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
      {cards.map((card, idx) => (
        ...
        >
          ...
          <p className="text-2xl font-bold text-[#1A1C1D] leading-tight">{card.value}</p>
