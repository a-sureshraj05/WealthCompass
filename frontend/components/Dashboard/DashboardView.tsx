      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-[#1A3A6B] hover:bg-[#F5F5F7] rounded-lg transition-colors border border-[#D2D2D7]"
          >
            Refresh Data
          </button>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-1 w-8 h-0.5 bg-[#1A3A6B]" />
      </div>
