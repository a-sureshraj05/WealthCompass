...
const AIInsights: React.FC<Props> = ({ holdings }) => {
  ...
  return (
    ...
    >
      ...
      <button className="mt-4 pt-4 border-t border-[#D2D2D7] text-[11px] font-semibold text-[#007AFF] uppercase tracking-[0.05em] text-right hover:text-[#0062CC] transition-colors w-full text-right">
