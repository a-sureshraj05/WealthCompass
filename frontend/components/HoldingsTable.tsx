          ...
          {holdings.map((h) => {
            ...
            return (
              ...
              <tr key={h.id} className="hover:bg-slate-50 transition-colors">
                ...
                <td className="px-6 py-4 text-sm text-slate-700 font-medium">${avgPrice.toFixed(2)}</td>

                <td className="px-6 py-4 text-sm text-slate-700 font-medium">${currentPrice.toFixed(2)}</td>

                <td className="px-6 py-4">

                  <div className="text-sm font-bold text-slate-900">${(h.quantity * currentPrice).toLocaleString()}</div>
