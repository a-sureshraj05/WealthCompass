            ...
            "holdings": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "avgPrice": {"type": "number", "description": "Average purchase price per share"},
                        "currentPrice": {"type": "number", "description": "Current market price mentioned in statement"},
                        "category": {"type": "string", "description": "Sector or category (e.g. Technology, Health)"}
                    },
                    "required": ["ticker", "name", "quantity", "avgPrice", "currentPrice", "category"],
                },
            },
        },
        "required": ["holdings"],
...
def parse_statement(request: StatementRequest):
    try:
        ...
        if not response.candidates[0].content.parts:
            ...
            raise HTTPException(status_code=500, detail="The AI model returned an empty response part. It may not have understood the request.")
